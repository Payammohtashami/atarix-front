    ...
    return (
        <div className='container md:px-8 lg:px-20 xl:px-32 mx-auto'>
            <div className='py-8'>
                ...
                <div className='grid gap-4 mb-48 grid-cols-1 md:gap-12 md:grid-cols-3'>
                    {
                        cardData?.map((item) => (
                            <div
                                key={item?.id}
                            ...
                            >
                                <div className='flex flex-col items-center p-9 bg-center rounded-2xl mb-8' style={{backgroundImage: `url(${item?.bgImage})`}}>
